      ...
      <header className="w-full bg-blue-600 text-white shadow-md fixed top-0 left-0 z-50">
        <div className="max-w-7xl mx-auto flex justify-between items-center px-6 h-16">
          ...
          <div className="flex gap-4">
            <Link
              to="/signup"
              className="bg-emerald-500 hover:bg-emerald-600 px-4 py-2 rounded-md shadow-md text-white transition duration-300"
            >
              Sign Up
            </Link>
            <Link
              to="/login"
              className="bg-white text-blue-600 hover:bg-gray-100 px-4 py-2 rounded-md shadow-md transition duration-300"
            >
              Login
            </Link>
          </div>
